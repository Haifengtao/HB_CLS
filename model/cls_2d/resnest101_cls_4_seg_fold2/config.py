...
__C.general = {}
__C.general.log_path = "./cpts/cls/resnest101_2d_cls_4_seg_fold1/log"
__C.general.model_path = "./cpts/cls/resnest101_2d_cls_4_seg_fold1/model"


__C.data = {}
__C.data.train_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold1_2d_mix_train_temp.h5"
__C.data.val_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold1_2d_mix_test_temp.h5"
...
weight = torch.tensor([1, 0.45, 0.73, 0.95]).cuda()
