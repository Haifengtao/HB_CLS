...
__C.general = {}
__C.general.log_path = "./cpts/cls/resnest101_2d_cls_seg_fold3/log"
__C.general.model_path = "./cpts/cls/resnest101_2d_cls_seg_fold3/model"


__C.data = {}
__C.data.train_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold3_2d_mix_train.h5"
__C.data.val_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold3_2d_mix_test.h5"
...
__C.train = {}
__C.train.load_model = None #"./cpts/cls/resnest101_2d_cls_seg_fold3/model/5_model.pth"
...
__C.loss.losses = [torch.nn.CrossEntropyLoss(weight=weight.detach(), reduction="mean")]
