...
__C.general = {}
__C.general.log_path = "./cpts/cls_maoxing/resnest101_2d_cls_seg_fold1/log_cls_dice"
__C.general.model_path = "./cpts/cls_maoxing/resnest101_2d_cls_seg_fold1/model_cls_dice"
...
__C.train = {}
__C.train.load_model = "./cpts/cls_maoxing//resnest101_2d_cls_seg_fold1/model_cls_dice/20_model.pth"
...
# weight = torch.tensor([0.183, 0.817]).cuda()
