...
__C.general = {}
__C.general.log_path = "./cpts/cls_giloma/resnest101_2d_cls_seg_fold1/log_cls_dice"
__C.general.model_path = "./cpts/cls_giloma/resnest101_2d_cls_seg_fold1/model_cls_dice"


__C.data = {}
__C.data.train_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold1_2d_mix_train.h5"
__C.data.val_txt = r"../../dataset/tumor_cls/cross_val_h5_dataset/fold1_2d_mix_test.h5"
...
__C.train = {}
__C.train.load_model = None  # "./cpts/cls_giloma/resnest101_2d_cls_seg_fold1/model_cls_dice/20_model.pth" # None
...
# weight = torch.tensor([0.24, 0.76]).cuda()
# __C.loss.losses = [torch.nn.CrossEntropyLoss(weight=weight, reduction="mean")]
__C.loss.losses = [Losses.cls_DiceLoss(ignore_index=0).cuda()]
